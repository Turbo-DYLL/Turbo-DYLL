...
class MapViewer:
    def __init__(self, window_size=200):
        ...
        # not necessary to load the map here
    ...
    def update(self, set_waypoint = None, current_waypoint = None):
        ...
        try:
            ...
            if current_waypoint != None:
                current_waypoint_array = utils.get_coords_from_str_lines(current_waypoint)
    ...
    # don't use the mutable variable as default argument
    def interactive_map(self, car_coords):
        """
        ...
        while True:
            ...
            #putText()
            cv2.putText(description_canvas, "use AWSD to move around    Use Scroll Wheel to zoom", (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 255, 0), 3)
            cv2.putText(description_canvas, "Press 'P' to save  Press 'L' to discard", (100, 300), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 255, 0), 3)
            cv2.putText(description_canvas, "Press 'O' to quit&save  Press 'K' to quit&discard", (100, 500), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 255, 0), 3)
            # cv2.putText(description_canvas, "Have fun testing - Leo", (2000, 600), cv2.FONT_HERSHEY_SIMPLEX, 3, (191, 64, 191), 3)
            cv2.putText(description_canvas, "Green is current run   Blue is saved waypoint", (100, 700), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 255, 0), 3)
